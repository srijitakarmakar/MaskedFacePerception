% figure()
%  % === PO8 ===
%         f1 = strcat('unmasked_familiar_all_only_epochrej.mat');
%         A = load(f1);
%         %data1 = A.Data_4;
%         data1 = A.UM_Fa_all;
%         data1 = data1(59,:,:);
%         
%         f2 = strcat('unmasked_unfamiliar_all_only_epochrej.mat');
%         B = load(f2);
%         %data2 = B.Data_6;
%         data2 = B.UM_UF_all;
%         data2 = data2(59,:,:);
%         
%         f3 = strcat('unmasked_famous_all_only_epochrej.mat');
%         C = load(f3);
%         %data3 = C.Data_5;
%         data3 = C.UM_F_all;
%         data3 = data3(59,:,:);
...
% figure()
%  % === PO8 ===
%         f1 = strcat('masked_familiar_all_only_epochrej.mat');
%         A = load(f1);
%         %data1 = A.Data_4;
%         data1 = A.M_Fa_all;
%         data1 = data1(59,:,:);
%         
%         f2 = strcat('masked_unfamiliar_all_only_epochrej.mat');
%         B = load(f2);
%         %data2 = B.Data_6;
%         data2 = B.M_UF_all;
%         data2 = data2(59,:,:);
%         
%         f3 = strcat('masked_famous_all_only_epochrej.mat');
%         C = load(f3);
%         %data3 = C.Data_5;
%         data3 = C.M_F_all;
%         data3 = data3(59,:,:);
